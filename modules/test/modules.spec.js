...
describe('modules', () => {
    ...
    it('should build modules with dependencies', () => {
        ...
        expect(emitModules(project.dir)).to.shallowDeepEqual([
            {name: 'c', path: resolve(project.dir, './c'), relativePath: 'c', version: '1.0.0', dependencies: []},
            {
                name: 'b', path: resolve(project.dir, './b'), relativePath: 'b', version: '1.0.0', dependencies: [
